...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(110, 15, utf8_decode('TextilExport'), 1, 1, 'C', 0); // AnchoCelda,AltoCelda,titulo,borde(1-0),saltoLinea(1-0),posicion(L-C-R),ColorFondo(1-0)
...
/* TABLA */
foreach($_SESSION["carrito"] as $productos2 => $product2){
$pdf->Cell(30, 10, utf8_decode($productos2), 1, 0, 'C', 0);
$pdf->Cell(80, 10, utf8_decode($product2["producto"]), 1, 0, 'C', 0);
$pdf->Cell(30, 10, utf8_decode($product2["Precio"]), 1, 0, 'C', 0);
$pdf->Cell(45, 10, utf8_decode($product2["cantidad"]), 1, 1, 'C', 0);
}
$pdf->SetTextColor(228, 100, 0);
$pdf->Cell(85); // mover a la derecha
$pdf->SetFont('Arial', 'B', 15);
$pdf->Cell(55, 10, utf8_decode('Total: $' ), 1, 0, 'C', 0);
$pdf->Ln(0);
$pdf->SetTextColor(228, 100, 0);
$pdf->Cell(85); // mover a la derecha
$pdf->SetFont('Arial', 'B', 15);
$pdf->Cell(85, 10, utf8_decode($total), 0, 1, 'C', 0);
$pdf->Ln(7);
//$pdf->Cell(70, 10, utf8_decode("info"), 1, 0, 'C', 0);
//$pdf->Cell(25, 10, utf8_decode("total"), 1, 1, 'C', 0);


$pdf->Output('F', '../PDF/Prueba.pdf'/*'Prueba.pdf', 'I'*/);//nombreDescarga, Visor(I->visualizar - D->descargar)
//$pdf->Output('Prueba.pdf', 'I');
echo "<script>alert('PDF Se genero correctamente. Si desea ver el contenido del documento, ingresar su correo Electronico para el envio de un mensaje.');</script>";
